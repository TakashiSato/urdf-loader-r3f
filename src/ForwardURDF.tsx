import { FC, ReactNode, forwardRef, MutableRefObject, useEffect, useRef, useState } from 'react';
...
const ForwardURDF = forwardRef<Mesh, PropsWithChildren>((props, ref) => {
  useEffect(() => {
